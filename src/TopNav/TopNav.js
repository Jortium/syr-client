  ...
  render(){
    return (
        ...
        <Link to='/post'><i className="far fa-plus-square squareM"></i></Link>
            ...
            <li className="navLinkM"><Link to='/board'><i className="far fa-comments"></i></Link></li>
              <li className="navLinkM"><Link to='/about'><i className="fas fa-cogs"></i></Link></li>
              <li className="navLinkD"><Link to='/board'><i className="far fa-comments"></i> Board</Link></li>
